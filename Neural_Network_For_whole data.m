...
[X,y] = extract_data('Test.set',"saccade");
...
% plot for each timeframe is heavy, we will see later
% % Plot Examples
% 
...
% Accuracy percentage
    for trial = 1:length(X) 
        ...
        correct_percentage = (correct/length(X))*100 %Convert to a percentage
        correct_total(trial) = correct_percentage
    end
